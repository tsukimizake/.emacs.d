...

;;;### (autoloads nil "tls-patch" "tls-patch.el" (0 0 0 0))
;;; Generated autoloads from tls-patch.el

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "tls-patch" '("tls-patch--use-tls-program")))

;;;***

;;;### (autoloads nil "wandbox" "wandbox.el" (0 0 0 0))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "wandbox" '("wandbox-")))

;;;***

;;;### (autoloads nil nil ("wandbox-pkg.el") (0 0 0 0))
