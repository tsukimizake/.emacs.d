...
/* package HaskellEmacs-0.0.0 */
#define VERSION_HaskellEmacs "0.0.0"
#define MIN_VERSION_HaskellEmacs(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  0 || \
  (major1) == 0 && (major2) == 0 && (minor) <= 0)

/* package atto-lisp-0.2.2.2 */
#define VERSION_atto_lisp "0.2.2.2"
...
#define CURRENT_COMPONENT_ID "HaskellEmacs-0.0.0"

#define CURRENT_PACKAGE_KEY "HaskellEmacs-0.0.0"
