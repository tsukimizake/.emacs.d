...
-- hash of all functions: 8840860eb69bd6159f879f5a333c55b74140e237
...
dispatcher = M.fromList $
  ...
  ] ++ []++[("Hoge.hoge", transform (\ (x1, x2) -> Hoge.hoge x1 x2)),
...
arityList = []++[("Hoge.hoge", arity Hoge.hoge),
 ("Matrix.transpose", arity Matrix.transpose),
